...
def generate_labyrinth_array(rows, cols):
    """
...
def create_labyrinth():
    # labyrinth_data = generate_labyrinth_array(50,50)
    # labyrinth_data = generate_dfs_labyrinth(10)
    labyrinth = html.Div(
        id='labyrinth',
        children=[
...
def generate_labyrinth_on_refresh(_):
    side_size = random.choice(range(500,501))  # Define labyrinth size
